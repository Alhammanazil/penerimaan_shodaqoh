    ...
    <div class="container">
        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#pilih-tanggal" role="tab"
                    aria-controls="nav-home" aria-selected="true">Hari ini</a>
                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#total" role="tab"
