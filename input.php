...
<body>
    ...
    <form id="inputForm" action="php/input.php" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" id="kodetrx" name="kodetrx" required class="form-control" value="<?php echo $kodetrx ?>"
                readonly>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="operator" name="operator" required class="form-control"
                value="<?php echo $namaOperator; ?>" readonly>
        </div>

        <!-- Field Tanggal -->
        <div class="form-group">
            <label for="tanggal">Tanggal:</label>
            <input type="date" id="tanggal" name="tanggal" required class="form-control" value="<?php echo $tanggal; ?>"
                readonly>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" id="sumbangan_uang" name="sumbangan_uang" required class="form-control"
                    value="<?= number_format($total_nominal, 0, ',', '.'); ?>" readonly>
            </div>
        </div>
        ...
        <div class="form-group" id="update_form">
            ...
            <input type="text" id="barcode_search" placeholder="ID Kartu" name="ambil_kartu" class="form"
                value="<?= $ambil_kartu; ?>" required>
            <!-- <div class="input-group-prepend">
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <!-- Button tambah data -->
                    <a href="input_detail.php?kodetrx=<?= $kodetrx; ?>&tanggal=<?= $tanggal; ?>"
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-danger delete-btn"
                                data-kodetrx_detail="<?= $rows['kodetrx_detail'] ?>"><i
